...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **أكشن يخطف الأنفاس (لجذب المشاهد فوراً):** الأطفال يملون بسرعة! لذلك يجب أن تكون القصة عبارة عن **(خطر داهم، هروب مجنون، أو كارثة)**! لا تجعلهم يستكشفون المكان بهدوء وبطء، بل اجعلهم (يسقطون، يهربون من وحش، أو يعلقون في فخ مرعب) داخل الجسم! يجب أن يكون إيقاع القصة (أكشن وسرعة) ليجبر المشاهد على استكمال الفيديو ومتابعة الأحداث. **يُمنع تماماً توجيه الحديث للمشاهد.**\n" +
      "- **الخطفة البصرية والمكان (Visual Hook):** لكي تلفت انتباه المشاهد، يجب أن يكون المكان مبهراً بصرياً (ألوان نيون متوهجة، إضاءة سينمائية سحرية، أحجام عملاقة مرعبة أو مذهلة). المكان هو نفس موضوع الدرس ولكن مجسم كعالم خيالي (مثلاً: كهف وردي عملاق ينبض بالضوء ويمثل الرئتين، أو شلال دماء أحمر لامع). صِف هذا في الـ SCENE بالإنجليزية: (Hyper-detailed, glowing neon colors, bioluminescent, massive epic cinematic scale). IMPORTANT: Do NOT include smart screens. The text \"Sci.Rehab Elsibai\" MUST be naturally carved in the background (perfectly spelled) without the camera focusing on it.\n" +
      "- **البداية المباشرة (In Media Res):** الفيديو الأول يبدأ وهم في قمة الأزمة! (مثلاً وهم يسقطون ويصرخون، أو يهربون من شيء). يُمنع منعاً باتاً تضييع المشهد الأول في عرض الاسم أو التمهيد الهادئ. ادخل في الأكشن فوراً!\n" +
      "- **المغامرة داخل موضوع الدرس نفسه (رحلة استكشاف مجهرية):** إياك أن تجعل الشخصيات تشرح الدرس بطريقة تقليدية (مثل: ما هو العضو؟). بدلاً من ذلك، حوّل المعلومات العلمية إلى (عقبات أو ألغاز) يواجهونها أثناء هروبهم أو مغامرتهم **داخل موضوع الدرس نفسه!** (مثلاً: إذا كان الدرس عن الجهاز التنفسي، فالحيوانات تم تصغيرها وهم عالقون داخل 'نفق القصبة الهوائية' العملاق وتضربهم 'عاصفة الهواء'). المشاهد سيتعلم المعلومة العلمية من خلال مشاهدة الأكشن والمغامرة!\n" +
      "- **الشخصيات الإجبارية (أبطال الفيلم):** لكي نتجنب أخطاءك السابقة، **يُمنع منعاً باتاً تجسيد أعضاء الجسم أو الغازات!** الشخصيات التي ستستخدمها في القصة يجب أن تكون إجبارياً من هذه القائمة فقط: (ثعلب عجوز، ضفدع صغير متسرع، بومة، دب، أرنب). اختر 3 منهم فقط في كل قصة. اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
      "- **اللهجة والحوار (عامية مصرية سريعة جداً):** الحوار يجب أن يكون كله (خوف، توتر، استعجال، أو صدمة) بلهجة مصرية شعبية دارجة ومضحكة (مثلاً: \"حاسب يا عم هانقع!\"، \"إيه الإعصار المرعب ده؟ احنا جوه الرئة ولا إيه؟\"). استخدم الكثير من علامات التعجب (!) لزيادة سرعة وحماس الصوت.\n" +
      "- **الجدار الرابع (ممنوع التحدث للجمهور):** يُمنع منعاً باتاً التحدث للجمهور أو النظر إليهم أو طرح أسئلة عليهم! إياك أن تستخدم كلمات مثل: (يا أصحابي، يا مصريين، يا حلوين، يا أصدقائي، يا جماعة، فكروا معايا). الشخصيات تعيش في مأزقها ولا تعلم بوجود كاميرا!\n" +
