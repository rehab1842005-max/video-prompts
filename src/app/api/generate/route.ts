...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      ...
      "- **تحويل الدرس إلى قصة سينمائية (Storytelling):** ممنوع ذكر المعلومات العلمية كنص مدرسي جاف! حوّل المعلومة إلى (أحداث في القصة) يكتشفها الأبطال بأنفسهم خلال مغامرتهم. يجب أن يفهم المشاهد الفكرة العلمية من خلال الأحداث وما تفعله الشخصيات، وليس من خلال التلقين المباشر.\n" +
      ...
      "- **اللهجة والحوار (عامية مصرية جذابة للأطفال):** الحوار عبارة عن مغامرة شيقة (اكتشاف، حيرة، أو إنقاذ) وليس شرحاً هادئاً، ولا تجعله مجرد صراخ غير مفهوم. اجعل الحوار يجذب الأطفال بلهجة مصرية شعبية دارجة لذيذة وواضحة (مثلاً: \"احنا لازم نلاقي طريق الهوا بسرعة!\"، \"المكان ده غريب أوي يا جماعة!\").\n" +
      "- **الجدار الرابع (ممنوع التحدث للجمهور):** يُمنع منعاً باتاً التحدث للجمهور أو طرح أسئلة عليهم! إياك أن تستخدم كلمات مثل: (يا مصريين، يا حلوين، يا أصدقائي، حد فيكوا يقولي، فكروا معايا). الشخصيات لا تعلم بوجود كاميرا أو مشاهدين، هم فقط يتحدثون مع بعضهم البعض داخل الغابة!\n" +
