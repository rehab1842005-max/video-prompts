...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **سلاسة اللغة، الكوميديا، والمعلومات الصريحة (مهم جداً جداً):**\n" + 
                          ...
                          "  3. **الموازنة بين الكوميديا والعلم:** استخدم تشبيهات مضحكة جداً، ولكن **يجب ذكر المعلومة العلمية بشكل صريح ومباشر وواضح** لتصل للأطفال دون لبس. لا تجعل الكوميديا تطغى على وضوح المعلومة العلمية.\n" +
