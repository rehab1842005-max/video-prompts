...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      ...
      "- **تحويل الدرس إلى استعارة سينمائية (Metaphor):** ممنوع ذكر المعلومات العلمية كنص مدرسي جاف! حوّل المعلومة إلى (أزمة درامية) في عالمهم. (مثلاً: بدلاً من سؤال \"ما هو العضو المسؤول عن تبادل الغازات؟\"، تجعل الشخصية تصرخ برعب: \"طريق الهوا مسدود فوق! مين اللي قفل الأبواب بيننا وبين المناخير؟!\"). **يجب أن تكون المشكلة واضحة جداً للمشاهد لكي يفهم الفكرة من الحكاية بسهولة.**\n" +
