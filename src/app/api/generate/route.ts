...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **الشاشات التعليمية (تجسيد الكلام كفيديو 100%):** أي شيء تقوله المعلمة أو الكرتون يجب أن يُعرض كفيديو حي على الشاشة الذكية! **ممنوع الكلمات المكتوبة نهائياً**. يجب أن تجبر الذكاء الاصطناعي بكتابة هذه العبارة بالنص في خانة الـ ACTION: (The smart screen is playing a vivid animated video showing EXACTLY what the character is explaining: [اكتب هنا وصف بصري دقيق بالإنجليزية لما تتحدث عنه الشخصية]). هذا لضمان أن كل ما يُشرح يتم تجسيده كفيديو أمام الأطفال.\n";
