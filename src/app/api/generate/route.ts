...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **اختلاف الأصوات والمشاعر والسرعة (AUDIO):** في خانة الـ AUDIO، يجب أن تكتب وصفاً يركز على (السرعة الفائقة، والمشاعر الجياشة كالصراخ أو الخوف أو الحماس) بالإنجليزية! (مثلاً: Extremely fast-paced, highly emotional, panicked and screaming voice). يجب أن يكون الصوت مختلفاً جذرياً لكل شخصية لكي لا تتشابه الأصوات! مع الحفاظ دائماً على كتابة: (Voice starts immediately at 0:00. NO intro music at all. Just clean voice).\\n";
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **أسلوب فيلم ديزني (مغامرة متكاملة ومفهومة جداً):** المشاهد يتفرج على فيلم كرتون ممتع له حبكة واضحة (بداية، وسط، نهاية)! لا تجعل الشخصيات تصرخ بدون سبب، بل اجعلهم في (مهمة إنقاذ، أو رحلة استكشاف، أو يحلون لغزاً). يجب أن تكون القصة منطقية، ومترابطة الأحداث، ومفهومة جداً للمشاهد لكي تجذبه للمتابعة. **يُمنع تماماً توجيه الحديث للمشاهد أو طرح أي أسئلة عليه.**\n" +
      "- **البداية المباشرة للأحداث (ممنوع تضييع الوقت):** ابدأ القصة فوراً في الفيديو الأول! الشخصيات تتحدث وتتجادل منذ الثانية الأولى. يُمنع منعاً باتاً تضييع المشهد الأول في عرض الاسم أو الموسيقى أو لقطات تمهيدية للكاميرا. ادخل في الأكشن والدراما فوراً!\n" +
      "- **المغامرة داخل موضوع الدرس نفسه (رحلة استكشاف مجهرية سينمائية):** إياك أن تجعل الشخصيات تشرح الدرس أو تطرح أسئلة (مثل: ما هو العضو؟). بدلاً من ذلك، اجعل الأبطال (الحيوانات) يقومون برحلة استكشاف سينمائية مذهلة (على غرار فيلم 'أتوبيس المدرسة السحري') **داخل موضوع الدرس نفسه!** مثلاً: إذا كان الدرس عن الجهاز التنفسي، فالحيوانات تم تصغيرها وهم الآن يمشون فعلياً داخل 'نفق القصبة الهوائية' العملاق، وينزلقون نحو 'كهف الرئتين الوردي'. يجب أن يستكشفوا هذا العالم، وينبهروا به، وتحدث لهم أزمة بداخله. المشاهد يجب أن يفهم بوضوح شديد أين هم وما هذا المكان!\n" +
      "- **المكان يعكس العالم العلمي المجهري (Dynamic Scene):** المكان ليس غابة عادية! بل هو (البيئة العلمية للدرس ولكن مجسمة كعالم سينمائي ضخم). (مثلاً: نفق لحمي عملاق يمثل القصبة الهوائية، أو أنهار حمراء تمثل الأوعية الدموية). صِف تفاصيل المكان بالإنجليزية بدقة في الـ SCENE! A beautiful 3D Pixar-style cinematic setting INSIDE the scientific topic (e.g. microscopic view inside a human body, or deep space). IMPORTANT: Do NOT include any smart screens or educational elements! It must look like an epic movie exploration. However, the exact text \"Sci.Rehab Elsibai\" MUST be naturally integrated into the environment (e.g., glowing on a cell wall, carved into a bone). The FULL text \"Sci.Rehab Elsibai\" must be perfectly spelled and COMPLETELY VISIBLE in the background of EVERY video without drawing attention.\n" +
      "- **الشخصيات الإجبارية (أبطال الفيلم):** لكي نتجنب أخطاءك السابقة، **يُمنع منعاً باتاً تجسيد أعضاء الجسم أو الغازات! (ممنوع رئة ناطقة أو أكسجين ناطق أو خلية ناطقة)**. الشخصيات التي ستستخدمها في القصة يجب أن تكون إجبارياً من هذه القائمة فقط: (ثعلب عجوز حكيم، ضفدع صغير متهور، بومة ذكية، أو دب طيب). اختر 3 منهم فقط في كل قصة. اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
      "- **اللهجة والحوار (عامية مصرية جذابة للأطفال):** الحوار عبارة عن مغامرة شيقة (اكتشاف، حيرة، أو إنقاذ) وليس شرحاً هادئاً، ولا تجعله مجرد صراخ غير مفهوم. اجعل الحوار يجذب الأطفال بلهجة مصرية شعبية دارجة لذيذة وواضحة (مثلاً: \"احنا لازم نلاقي طريق الهوا بسرعة!\"، \"المكان ده غريب أوي!\").\n" +
      "- **الجدار الرابع (ممنوع التحدث للجمهور):** يُمنع منعاً باتاً التحدث للجمهور أو النظر إليهم أو طرح أسئلة عليهم! إياك أن تستخدم كلمات مثل: (يا أصحابي، يا مصريين، يا حلوين، يا أصدقائي، يا جماعة، فكروا معايا، تفتكروا إيه). الشخصيات لا تعلم بوجود مشاهدين، الكاميرا تتلصص عليهم وهم يعيشون حياتهم في الغابة!\n" +
