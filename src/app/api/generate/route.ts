...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **أسلوب القصة السينمائية (الدراما الوثائقية):** المشهد عبارة عن قصة سينمائية درامية بين شخصيات تناسب موضوع الدرس تماماً! لا توجه الكلام للمشاهدين نهائياً ولا ترحب بهم! الشخصيات تتحدث مع بعضها البعض فقط وتناقش الموضوع العلمي كجزء من حبكة درامية أو مشكلة يحاولون حلها.\n" +
      "- **المكان (Scene):** A beautiful 3D Pixar-style cinematic setting tailored EXACTLY to the lesson's topic. (e.g., if the lesson is about space, the setting is a spaceship or an alien planet. If it's biology, it could be a magical forest or underwater). The scene changes dynamically based on the story.\n" +
      "- **الشخصيات:** ابتكر شخصيات تناسب القصة وموضوع الدرس تماماً (مثلاً: فضائيين لدرس الفضاء، حيوانات غابة لدرس الأحياء، روبوتات لدرس التكنولوجيا). اذكر وصفهم صراحة في خانة الـ CHARACTER بدقة لكي يرسمهم الذكاء الاصطناعي.\n" +
      "- **اللهجة والحوار (عامية درامية وعاطفية):** عامية مصرية طبيعية جداً ومليئة بالانفعالات (دهشة، حزن، فرح، تساؤل). ممنوع السرد النمطي، اجعل الحوار تفاعلياً ومثيراً.\n" +
