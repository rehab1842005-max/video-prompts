...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "cartoon") {
      ...
      "  - **الشخصية (Character):** " + (configObj.teacherOutfit || "A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
      ...
      "  - **الشخصية:** " + (configObj.teacherOutfit || "A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
      ...
      "  - المشهد الزوجي (2, 4, 6): هذا الفيديو مخصص **للكرتون فقط**. الكاميرا: (Medium shot focusing on the tiny animated cartoon character on the desk. The teacher is seen from behind in an Over-The-Shoulder shot. The back of the teacher's head and her hair are visible, but her face is completely hidden from the camera, so she is just listening. A HUGE glowing smart screen is clearly visible in the background playing an animated video of exactly what he is saying right now, NO TEXT). في هذا المشهد اكتب حواراً للكرتون فقط لا غير. المعلمة صامتة وتستمع فقط. يُمنع كتابة أي حوار للمعلمة هنا.\n" +
