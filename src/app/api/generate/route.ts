...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **أسلوب القصة السينمائية (دراما وأسرار وحبكة):** ممنوع الشرح المباشر! المشهد عبارة عن فيلم سينمائي فيه (مشكلة كبيرة، إفشاء سر، شجار، فضفضة، أو عتاب) بين الشخصيات. لا توجه الكلام للمشاهدين نهائياً. الشخصيات تتحدث مع بعضها في سياق هذه الدراما، وفي نهاية هذه الحبكة يتم استنتاج المعلومة العلمية كدرس مستفاد أو كحل للمشكلة!\n" +
      "- **المكان (Scene):** A beautiful 3D Pixar-style cinematic setting tailored EXACTLY to the lesson's topic. (e.g., if the lesson is about space, the setting is a spaceship or an alien planet. If it's biology, it could be a magical forest or underwater). The scene changes dynamically based on the story. In the background of every scene, there MUST be a HUGE glowing smart screen to show educational visuals, and a HUGE glowing neon sign displaying the exact typographic text \"Sci.Rehab Elsibai\". The FULL text \"Sci.Rehab Elsibai\" must be perfectly spelled and COMPLETELY VISIBLE without any missing words.\n" +
      "- **الشخصيات:** ابتكر شخصيات تناسب القصة وموضوع الدرس (مثلاً: كائنات فضائية، حيوانات، أدوات معمل ناطقة). يجب أن تكون شخصياتهم متناقضة (شخص حكيم يوبّخ، وشخص متهور يخطئ) لخلق الدراما. اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
      "- **اللهجة والحوار (عامية مصرية درامية قحة):** استخدم عامية مصرية شعبية ومليئة بالانفعالات الحقيقية والتوبيخ والدراما (مثلاً: \"إنت خريت على كل حاجة\"، \"الندم مابيصلحش اللي اتكسر\"، \"وطي صوتك لتفضحنا\"). الحوار يجب أن يكون في قمة الإثارة وليس مجرد سرد معلومات.\n" +
