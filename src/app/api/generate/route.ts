...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **حبكة المستكشفين الصغار (قصة مفهومة ومترابطة جداً):** لكي تكون القصة مفهومة للمشاهد، اجعلها عبارة عن (رحلة استكشاف مجهرية)! الأبطال هم فريق من المستكشفين تم تصغيرهم جداً وهم الآن يسافرون (سيراً على الأقدام أو في غواصة صغيرة) **داخل** جسم الإنسان أو موضوع الدرس! وهم يمشون، يتفاجؤون بالأشياء التي يرونها ويتفاعلون معها. هذه الحبكة البسيطة ستجعل القصة مفهومة جداً ومتوافقة تماماً مع ترتيب الدرس. **يُمنع تماماً توجيه الحديث للمشاهد.**\n" +
      "- **القائمة السوداء للكلمات المدرسية (قاعدة حياة أو موت):** الذكاء الاصطناعي يخطئ وينسخ أسئلة الدرس الحرفية المكتوبة في الملف ليضعها على لسان الشخصيات! هذا يدمر الفيلم! **يُمنع منعاً باتاً تحت أي ظرف استخدام الكلمات الأكاديمية التالية في الحوار:** (العضو المسؤول، عملية، تبادل الغازات، يا ترى مين، الجهاز، وظيفة). المستكشفون لا يسألون كالمعلمين! بل ينبهرون بما يرونه! (مثلاً بدلاً من قول 'ما هو العضو المسؤول عن تبادل الغازات؟'، يقول المستكشف وهو ينظر حوله بذهول: 'يا خبر أبيض! إيه الكهف الوردي العملاق ده؟ ده أكيد المكان اللي بيسحب الهوا للجسم!'). إياك أن تجعل الحوار يبدو كمعلم يختبر طلابه!\n" +
      "- **المكان (البيئة الداخلية المجسمة):** المكان هو موضوع الدرس ذاته ولكن مجسم كعالم سينمائي مبهر للعين! (مثلاً: نفق لحمي عملاق يمثل القصبة الهوائية، أو غابة من الشعيرات داخل الأنف). صِف هذا في الـ SCENE بالإنجليزية: (Hyper-detailed, glowing, massive epic cinematic scale). IMPORTANT: Do NOT include smart screens. The text \"Sci.Rehab Elsibai\" MUST be naturally carved in the background without the camera focusing on it.\n" +
      "- **البداية المباشرة (In Media Res):** الفيديو الأول يبدأ وهم في منتصف رحلة الاستكشاف منبهرين أو خائفين من شيء ضخم أمامهم! يُمنع منعاً باتاً تضييع المشهد الأول في عرض الاسم أو التمهيد الهادئ.\n" +
      "- **الشخصيات (حيوانات الطبيعة المستكشفة):** يُمنع منعاً باتاً تجسيد أعضاء الجسم (ممنوع رئة ناطقة)! اختر 3 شخصيات من حيوانات الطبيعة العادية (مثل الدب، الثعلب، الأرنب، الخ) يرتدون ملابس استكشاف (مثل قبعات السفاري أو نظارات الغوص). اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
      "- **اللهجة والحوار (عامية مصرية سريعة جداً):** الحوار يجب أن يكون كله (انبهار، توتر، استعجال، أو صدمة) بلهجة مصرية شعبية دارجة ومضحكة (مثلاً: \"حاسب يا عم هانقع في النفق ده!\"، \"المكان هنا غريب أوي وعمال يتحرك!\"). استخدم الكثير من علامات التعجب (!) لزيادة سرعة وحماس الصوت.\n" +
      "- **الجدار الرابع (ممنوع التحدث للجمهور):** يُمنع منعاً باتاً التحدث للجمهور أو طرح أسئلة عليهم! إياك أن تستخدم كلمات مثل: (يا أصحابي، يا مصريين، يا حلوين، يا أصدقائي، يا جماعة، فكروا معايا). الشخصيات تعيش في مغامرتها ولا تعلم بوجود كاميرا!\n" +
