...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      ...
      "- **الدراما والحبكة:** اخلق فيلم سينمائي فيه (مشكلة، إفشاء سر، شجار، أو عتاب) بين الشخصيات. الشخصيات تتحدث مع بعضها كأنهم في حياتهم الطبيعية تماماً دون توجيه الحديث للمشاهدين، وفي نهاية القصة يتم استنتاج فكرة الدرس كـ \"عبرة مستترة\" أو \"حل للمشكلة\" بدون تلقين علمي جاف!\n" +
      ...
      "- **الشخصيات (أبطال الفيلم):** يُمنع منعاً باتاً جعل الشخصيات عبارة عن (مفاهيم علمية ناطقة) مثل (جزئ أكسجين ناطق أو خلية ناطقة)! الشخصيات يجب أن تكون كائنات حقيقية أو خيالية ملموسة (حيوانات الغابة كالماعز والثعلب، وحوش لطيفة، كائنات فضائية، سحرة، مغامرين). هذه الشخصيات تعيش مغامرة وتواجه مشكلة، والحل يكون هو الفكرة العلمية. يجب أن تكون هناك 3 أنماط: (1) شخصية طيبة وحكيمة، (2) شخصية شريرة أو متهورة ومخطئة، (3) شخصية بريئة تتعلم وتستكشف. اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
