...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **تخصيص الأصوات لكل شخصية (AUDIO):** في خانة الـ AUDIO، يجب أن تكتب وصفاً دقيقاً ومميزاً لصوت المتحدث لكي لا تتشابه الأصوات! إذا كانت المعلمة تتحدث اكتب: (Warm, clear, and engaging female adult teacher voice). وإذا كان الكرتون يتحدث ابتكر له صوتاً مميزاً (مثلاً: Funny high-pitched cartoon voice، أو Goofy deep voice). مع الحفاظ دائماً على كتابة: (Voice starts immediately at 0:00. NO intro music at all. Just clean voice).\\n";
    characterConfigStr += "- **سلاسة اللغة، الكوميديا، والمعلومات الصريحة (مهم جداً جداً):**\n" + 
                          ...
                          "  2. **ممنوع الترحيب المتكرر:** قل (أهلاً بيكم يا أبطالي) في **المشهد الأول فقط لا غير!** يُمنع منعاً باتاً تكرار الترحيب في باقي المشاهد، ادخل في صلب الشرح فوراً.\n" +
                          "  3. **الموازنة بين الكوميديا والعلم:** استخدم تشبيهات مضحكة جداً (مثلاً: الكواكب بتلف زي النحلة)، ولكن **يجب ذكر المعلومة العلمية بشكل صريح ومباشر وواضح** لتصل للأطفال دون لبس. لا تجعل الكوميديا تطغى على وضوح المعلومة العلمية.\n" +
                          "  4. **تطابق المتحدث مع الكاميرا (لمنع تبادل الأدوار):** الشخصية التي تتحدث في خانة (DIALOGUE) يجب أن تكون هي نفسها الشخصية التي تركز عليها (CAMERA) وهي نفسها المذكورة كمتحدث في (ACTION). لا تجعل الكاميرا تركز على الكرتون بينما المعلمة هي من تتحدث!\n" +
                          "  5. **التوزيع العادل للكلام (مهم جداً للاحترافية):** يجب أن يكون هناك توازن مثالي و\"عدل\" في مساحة الكلام بين الشخصيتين. لا تجعل شخصية تشرح طوال الوقت والأخرى تقول كلمة واحدة. قسم المعلومات والنكات بالتساوي التام بينهم.\n" +
                          "  6. **متحدث واحد فقط (ممنوع المقاطعة):** يُمنع منعاً باتاً كتابة حوار لشخصيتين في نفس خانة الـ (DIALOGUE). المتحدث يُكمل جملته للنهاية بدون أي مقاطعة. إذا أردت للشخصية الأخرى أن ترد أو تقاطع، يجب أن يكون ذلك في المشهد (الفيديو) المنفصل الذي يليه.\n";
    ...
    characterConfigStr += "- **الشاشات التعليمية والتمثيل المضحك (تجسيد الكلام كفيديو 100%):** أي شيء تقوله المعلمة أو الكرتون يجب أن يُعرض كفيديو حي على الشاشة! وإذا كانت الشخصية تقول تشبيهاً مضحكاً، يجب أن تمثله بجسدها وتعابير وجهها، ويُعرض هذا التشبيه كفيديو مضحك على الشاشة! يجب كتابة هذه العبارة بالنص في خانة الـ ACTION: (The smart screen is playing a vivid animated video showing EXACTLY what the character is explaining/joking about: [اكتب هنا وصف بصري دقيق بالإنجليزية]. The screen displays ONLY pure visual images and animated pictures, absolutely NO text, NO letters, and NO words. The speaking character is actively ACTING OUT this metaphor with funny, highly expressive body language and hand gestures). هذا لضمان التمثيل المضحك ومنع تداخل النصوص.\n";

    if (videoMode === "story") {
      characterConfigStr += "\n- **أسلوب القصة السينمائية (الوثائقي الحيواني):** المشهد عبارة عن قصة سينمائية درامية بين حيوانات المزرعة (مثل بقرة حكيمة، ماعز، أرنب، ثعلب مكار). لا توجه الكلام للمشاهدين نهائياً ولا ترحب بهم! الشخصيات تتحدث مع بعضها البعض فقط في سياق القصة وتناقش الموضوع العلمي كجزء من حبكة درامية.\n" +
      "- **المكان (Scene):** A beautiful 3D Pixar-style cinematic farm setting. The scene changes dynamically based on the story (e.g., inside a rustic wooden barn with sunlight rays, outside in a green field, or at night under the moonlight). \n" +
      "- **الشخصيات:** ابتكر شخصيات حيوانات مزرعة تناسب القصة. اذكر وصف الحيوان صراحة في خانة الـ CHARACTER بدقة لكي يرسمه الذكاء الاصطناعي (مثل: A cute small white goat with a red bow, A large wise brown cow with a golden bell).\n" +
      "- **اللهجة والحوار (عامية درامية وعاطفية):** عامية مصرية طبيعية جداً ومليئة بالانفعالات (توبيخ، حزن، فرح، غضب). ممنوع السرد النمطي، اجعل الحوار تفاعلياً ومثيراً.\n" +
      "- **حركة الكاميرا والإخراج:** (Cinematic cuts, varying camera angles. Close-ups on characters' faces showing strong emotions like crying or laughing. Dynamic and highly expressive movements).\n" +
      "- **هام للشفاه (ممنوع التداخل):** يجب أن تكتب اسم الحيوان المتحدث بالإنجليزية وتأمر بأن باقي الحيوانات صامتة تماماً وفمها مغلق (The other animals are completely silent with mouths firmly closed).\n";
