...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "cartoon") {
      ...
      "  - **الشخصية (Character):** " + (characterConfig.teacherOutfit || "A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
      ...
      "  - **الشخصية:** " + (characterConfig.teacherOutfit || "A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
