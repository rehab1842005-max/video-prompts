...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **السر السحري لتطابق الشفاه (قاعدة إجبارية جداً):** في خانة الـ Action لأي شخصية تتحدث، يجب أن تكتب: (Speaking clearly, mouth is moving naturally in perfect sync). وبنفس الأهمية، يجب أن تكتب وصفاً دقيقاً للشخصية الثانية الصامتة في نفس المشهد هكذا: (The other character is COMPLETELY SILENT, listening attentively, with their mouth FIRMLY CLOSED and lips sealed. ONLY the speaker's mouth is moving). هذا ما يضمن عدم حركة فم الشخصيتين معاً!\n";
    characterConfigStr += "- **الشاشات التعليمية والتمثيل المضحك (تجسيد الكلام كفيديو 100%):** أي شيء تقوله المعلمة أو الكرتون يجب أن يُعرض كفيديو حي على الشاشة! وإذا كانت الشخصية تقول تشبيهاً مضحكاً، يجب أن تمثله بجسدها وتعابير وجهها، ويُعرض هذا التشبيه كفيديو مضحك على الشاشة! يجب كتابة هذه العبارة بالنص في خانة الـ ACTION: (The smart screen is playing a vivid animated video showing EXACTLY what the character is explaining/joking about: [اكتب هنا وصف بصري دقيق بالإنجليزية]. The speaking character is actively ACTING OUT this metaphor with funny, highly expressive body language and hand gestures). هذا لضمان التمثيل المضحك.\n";
    ...
    if (videoMode === "cartoon") {
      ...
      "- **المكان (Scene):** A magical, vibrant, and highly detailed 3D Pixar-style animated world suitable for the topic. In the background on the LEFT side of the frame, there is a HUGE cinematic glowing smart screen dominating the space to show educational videos, and a glowing neon sign displaying the exact typographic text \"Sci.Rehab Elsibai\". The words \"Sci.Rehab Elsibai\" must be spelled perfectly. Both cartoon characters are standing together on the RIGHT side of the frame, ensuring they NEVER block the huge smart screen. No human elements, just pure cartoon fantasy.\n" +
