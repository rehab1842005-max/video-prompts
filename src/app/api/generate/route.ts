...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **النهايات السينمائية وحركة الكاميرا للانتقال:** في خانة الـ END للـ ACTION، يجب أن تقوم الكاميرا بالدوران (Camera pans) للانتقال إلى المتحدث التالي لربط المشاهد ببعضها! اكتب صراحة بالإنجليزية: (The camera slowly pans to reveal the other character sitting, creating a seamless transition to the next scene). لا تجعل الشخصيات تلف جسمها، بل الكاميرا هي التي تتحرك (Pan) نحو الشخصية الأخرى التي ستتحدث في المشهد القادم.\n" + 
    ...
    if (videoMode === "cartoon") {
      ...
      "  - **الشخصية (Character):** A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing " + (configObj.teacherOutfit || "a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
      ...
      "  - **المكان:** A beautiful modern podcast studio. Neon purple lighting. A glowing neon sign says 'Sci.Rehab Elsibai'. Bookshelves with trailing plants. A wooden desk with a professional microphone and a laptop. **A cute animated cartoon character is sitting on a comfortable guest chair next to the teacher\'s desk, looking at the teacher.**\n" +
      "  - **الشخصية:** A beautiful 20-25 years old 3D Pixar-style young female teacher with long wavy dark brown hair, big brown eyes, wearing " + (configObj.teacherOutfit || "a purple headband, a white silk blouse, and a sleek purple blazer") + ". (Maintain exact same character design and proportions as the previous scene).\n" +
      ...
      "  - المشهد الفردي (1, 3, 5): هذا الفيديو مخصص **للمعلمة فقط**. الكاميرا: (Medium shot of the teacher. IMPORTANT for lip-sync: The teacher is facing the camera directly in a full frontal view. Her face and lips must be clearly visible from the front to ensure perfect lip-sync. A HUGE glowing smart screen is clearly visible beside her, completely unobstructed. The screen is playing a vivid animated video of exactly what she is saying right now, absolutely NO TEXT on screen). **ولحل مشكلة ظهور وجه الكرتون وسرقة الشفاه، اكتب صراحة وبقوة في وصف هذا المشهد أن الكرتون يعطي ظهره بالكامل للكاميرا ولا يظهر وجهه أبداً: (The cartoon character is sitting on its guest chair in the foreground with its BACK TURNED to the camera. IMPORTANT: 100% BACK VIEW ONLY. NO FACE, NO EYES, NO MOUTH visible. We only see the back of its head).** في هذا المشهد اكتب حواراً للمعلمة فقط لا غير.\n" +
      "  - المشهد الزوجي (2, 4, 6): هذا الفيديو مخصص **للكرتون فقط**. الكاميرا: (Cinematic Over-The-Shoulder shot from behind the teacher's right shoulder. The teacher is slightly out of focus in the foreground on the left side of the frame, showing only the back of her shoulder and hair. Her face is completely hidden. The camera focuses sharply on the animated cartoon character sitting on the guest chair in the background, who is facing the camera and talking. A HUGE glowing smart screen is clearly visible in the background playing an animated video of exactly what he is saying right now, NO TEXT). في هذا المشهد اكتب حواراً للكرتون فقط لا غير. المعلمة صامتة وتستمع فقط. يُمنع كتابة أي حوار للمعلمة هنا.\n" +
