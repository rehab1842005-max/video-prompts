...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **اختلاف الأصوات الجذري لكل شخصية (AUDIO):** في خانة الـ AUDIO، يجب أن تكتب وصفاً صوتياً **مختلفاً جذرياً** لكل شخصية (مثلاً: صوت عميق وخشن جداً للشرير، وصوت رفيع وسريع للطفل، وصوت أجش وعجوز للحكيم) لكي لا تتشابه أصواتهم أبداً وتكون مميزة! مع الحفاظ دائماً على كتابة: (Voice starts immediately at 0:00. NO intro music at all. Just clean voice).\\n";
