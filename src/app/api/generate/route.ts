...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **إلغاء الطابع العلمي تماماً (فيلم 100%):** المشاهد يجب أن يظن أنه يتفرج على فيلم ديزني أو فيلم كرتون حقيقي! يُمنع منعاً باتاً ذكر أي مصطلحات علمية معقدة أو إشعار المشاهد أنه في \"درس\".\n" +
      "- **الدراما والحبكة:** اخلق فيلم سينمائي فيه (مشكلة، إفشاء سر، شجار، أو عتاب) بين الشخصيات. الشخصيات تتحدث مع بعضها كأنهم في حياتهم الطبيعية تماماً، وفي نهاية القصة يتم استنتاج فكرة الدرس كـ \"عبرة مستترة\" أو \"حل للمشكلة\" بدون تلقين علمي جاف!\n" +
