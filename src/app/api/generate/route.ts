...
export async function POST(req: NextRequest) {
  try {
    ...
    characterConfigStr += "- **النهايات السينمائية وتمرير الدور (ممنوع الدوران نهائياً):** في خانة الـ END للـ ACTION، يُمنع منعاً باتاً كتابة أن الشخصية تستدير أو تلف جسمها (No spinning or turning around)! بدلاً من ذلك اكتب: (The character finishes speaking and maintains a natural pose for the final second, creating a seamless point for a camera cut). القطع بين زوايا الكاميرا (من الأمام إلى زاوية الكتف) سيتم في المونتاج، لذلك لا تجعل الشخصية تلف جسمها أبداً.\n" + 
    ...
    if (videoMode === "cartoon") {
      ...
      "  - **المكان:** A beautiful modern podcast studio. Neon purple lighting. A glowing neon sign says 'Sci.Rehab Elsibai'. Bookshelves with trailing plants. A wooden desk with a professional microphone and a laptop. **A tiny cute cartoon character is standing ON the desk next to the laptop, looking at the teacher.**\n" +
