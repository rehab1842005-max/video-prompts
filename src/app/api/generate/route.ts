...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "cartoon") {
      ...
      "  - **المكان:** A beautiful modern podcast studio. Neon purple lighting. A HUGE glowing neon sign displaying the exact typographic text \"Sci.Rehab Elsibai\". The FULL text \"Sci.Rehab Elsibai\" must be perfectly spelled and COMPLETELY VISIBLE without any missing words. Bookshelves with trailing plants. A wooden desk in the foreground clearly displaying a professional podcast microphone and an open laptop. **A tiny cute cartoon character is standing ON the desk next to the laptop, looking at the teacher.**\n" +
