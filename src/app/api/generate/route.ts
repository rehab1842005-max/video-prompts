...
export async function POST(req: NextRequest) {
  try {
    ...
    if (videoMode === "story") {
      characterConfigStr += "\n- **إلغاء الطابع العلمي تماماً (فيلم 100%):** المشاهد يجب أن يظن أنه يتفرج على فيلم ديزني أو فيلم كرتون حقيقي! يُمنع منعاً باتاً ذكر أي مصطلحات علمية معقدة، أو طرح أسئلة تعليمية مباشرة (مثل: ما هو العضو المسؤول؟)، أو إشعار المشاهد أنه في \"درس\". يُمنع تماماً تقمص شخصية المعلم!\n" +
      "- **الدراما والحبكة:** اخلق فيلم سينمائي فيه (مشكلة، إفشاء سر، شجار، أو عتاب) بين الشخصيات (مثلاً: أكسجين يتشاجر مع ثاني أكسيد الكربون). الشخصيات تتحدث مع بعضها كأنهم في حياتهم الطبيعية تماماً دون توجيه الحديث للمشاهدين، وفي نهاية القصة يتم استنتاج فكرة الدرس كـ \"عبرة مستترة\" أو \"حل للمشكلة\" بدون تلقين علمي جاف!\n" +
      ...
      "- **الشخصيات (ممنوع البشر):** يُمنع منعاً باتاً وجود أي معلمة أو إنسان بشري! الشخصيات يجب أن تكون فقط (حيوانات ناطقة، كائنات فضائية، أدوات معمل ناطقة، أو خلايا). يجب أن تكون شخصياتهم متناقضة (شخص حكيم يوبّخ، وشخص متهور يخطئ) لخلق الدراما. اذكر وصفهم صراحة في الـ CHARACTER بدقة.\n" +
      "- **اللهجة والحوار (عامية مصرية درامية قحة):** استخدم عامية مصرية شعبية ومليئة بالانفعالات الحقيقية والتوبيخ والدراما (مثلاً: \"إنت خريت على كل حاجة\"، \"الندم مابيصلحش اللي اتكسر\"، \"وطي صوتك لتفضحنا\"). الحوار يجب أن يكون في قمة الإثارة، ويُمنع تماماً التحدث بأسلوب المدرسين أو توجيه أسئلة للطلاب.\n" +
