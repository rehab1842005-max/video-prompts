...
"2. صف فقط ملابس المعلمة (teacherOutfit) بحيث تكون رسمية بناتي أنيقة ومميزة جداً (Blazers). **يجب دائماً أن ترتدي بليزر (Blazer) بلون مختلف وجذاب في كل مرة** (مثل: a sleek mint green blazer over a white silk blouse, أو a cute pastel pink blazer). **لا تكتب أي وصف لملامحها أو شعرها أبداً**، اكتب فقط الملابس! يجب أن ترتدي ملابس معلمة رسمية أنيقة (بليزرات) بألوان وتفاصيل متغيرة عن المعتاد.\n" +
